...
public static class AuxiliarMapGenerator
{
    ...
    private static void DeleteParents(Cell currentCell, List<Cell> visitedParents, List<Cell> roomCells)
    {
        ...
        // Si la celda no tiene padres, marcarla como vac�a
        ...
        // Si no est� en roomCells, marcarla como vac�a
    ...
    //    // Verificar si la habitaci�n puede insertarse en la cuadr�cula.
    //    for (int row = initialRow; row < initialRow + roomRows; row++)
    //    {
    //        for (int col = initialCol; col < initialCol + roomCols; col++)
    //        {
    //            // Verificar si estamos dentro de los l�mites del grid.
    //            if (row >= 0 && row < gridRows && col >= 0 && col < gridCols)
    //            {
    //                // Si la celda en roomGrid no est� vac�a y no es colocable en originalGrid.
    ...
    //            else
    //            {
    //                // Estamos fuera de los l�mites del originalGrid.
    ...
    //    // Verificar las celdas alrededor del �rea de la habitaci�n.
    ...
    //            {
    //                // Verificar si la celda est� en el per�metro (no dentro del roomGrid).
    //                if (row == initialRow - 1 || row == initialRow + roomRows || col == initialCol - 1 || col == initialCol + roomCols)
    //                {
    //                    // Comprobar si el per�metro tiene celdas vac�as o pasillos
    //                    if (originalGrid[row, col].State == CellState.Empty || originalGrid[row, col].State == CellState.Corridor)
    //                    {
    //                        isPossible = true; // Puede ser colocada si el per�metro es v�lido.
    //                    }
    //                    else
    //                    {
    //                        isPossible = false;
    ...
    public static bool IsPossibleInsertRoom(Cell[,] originalGrid, Cell[,] roomGrid, int initialRow, int initialCol)
    {
        ...
        // Verificar que la habitaci�n no est� en el per�metro del grid
    ...
    public static Cell[,] InsertRoom(Cell[,] grid, Cell[,] roomGrid, int initialRow, int initialCol, List<Cell> endCellList)
    {
        ...
        // Comprobar si es posible insertar la habitaci�n
