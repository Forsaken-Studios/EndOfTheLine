Shader "Universal Render Pipeline/2D/ElectricWall-Lit-Custom"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings CombinedShapeLightVertex(Attributes v)
            {
                ...
                o.color = v.color * _Color * _RendererColor * _ElecColor;
                return o;
            }
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                const half4 main = i.color * SAMPLE_TEXTURE2D(_ElecTex, sampler_ElecTex, uv);
